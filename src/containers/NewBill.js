...
export default class NewBill {
  ...
  handleChangeFile = (evt) => {
    ...
    // NOTE acceptation des bonnes extensions
    ...
    if (extension.test(file.name) && file.name.length > 0) {
